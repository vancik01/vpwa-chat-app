...
class ChannelService {
    ...
    async kickFromChannel(channelId: string, nickName: string): Promise<{message: string}> {
      const response = await api.post(`/channels/${channelId}/kick`, { kickedNickName: nickName})
      return response.data
    }
  }
